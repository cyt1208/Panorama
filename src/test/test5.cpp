...
int main(int argc, char **argv)
  ...
  save_image(cylindrical_project(a, 500), "output/cl_a");
  save_image(cylindrical_project(b, 500), "output/cl_b");

  save_image(spherical_project(a, 500), "output/s_a");
  save_image(spherical_project(b, 500), "output/s_b");
